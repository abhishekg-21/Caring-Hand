...
export const NAV: NavItem[] = [
  {
    ...
    href: "/about",
    children: [
      { label: "About Us", href: "/about" }, // Added href
      {
        ...
        children: [
          {
            ...
            href: "/work/privileged-children/child-for-child",
          },
        ...
        children: [
          {
            ...
            href: "/get-involved/corporate-partnerships/corporate-social-responsibility",
          },
          {
            label: "Cause Marketing & Events",
            href: "/get-involved/corporate-partnerships/cause-marketing-events",
          },
          {
            label: "Employee Engagement",
            href: "/get-involved/corporate-partnerships/employee-engagement",
          },
          {
            label: "Payroll Giving",
            href: "/get-involved/corporate-partnerships/payroll-giving",
          },
        ],
      },
...

  {
    ...
    children: [
      ...
      {
        label: "Print/ online media",
        href: "/media-centre/print-online-media",
      },
      { label: "Electronic Media", href: "/media-centre/electronic-media" },
      { label: "Workshop & Events", href: "/media-centre/workshop-events" },
      {
        label: "Eminent Personalities",
        href: "/media-centre/eminent-personalities",
      },
    ],
  },

  {
    ...
    children: [
      ...
      { label: "Films", href: "/resource-center/films" },
      {
        ...
        href: "/resource-center/stories-of-change",
      },
      {
        label: "Perspective",
        ...
        children: [
          {
            label: "Child Rights",
            href: "/resource-center/perspective/child-rights",
          },
        ],
      },
    ],
